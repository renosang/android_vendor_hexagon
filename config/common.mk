...
PRODUCT_COPY_FILES += \
    ...
    vendor/hexagon/prebuilt/common/bin/50-base.sh:system/addon.d/50-base.sh \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/hexagon/config/permissions/privapp-permissions-hexagon.xml:system/etc/permissions/privapp-permissions-hexagon.xml
...
# Branding
include vendor/hexagon/config/branding.mk
