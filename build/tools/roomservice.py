...
def is_in_manifest(projectpath):
    ...
    # ... and don't forget the hexagon snippet
    try:
        lm = ElementTree.parse(".repo/manifests/snippets/hexagon.xml")
        lm = lm.getroot()
    except:
        lm = ElementTree.Element("manifest")
...
print("Repository for %s not found in the HexagonRom Github repository list. If this is in error, you may need to manually add it to your local_manifests/roomservice.xml." % device)
