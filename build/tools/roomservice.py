...
custom_local_manifest = ".repo/local_manifests/hexagon.xml"
custom_default_revision = "pie"
custom_dependencies = "aosp.dependencies"
org_manifest = "hexagon"  # leave empty if org is provided in manifest
org_display = "HexagonRom"  # needed for displaying
